...
def get_hparam_config():
    ...
    return {
        ...
        # GCCA regularization (very important)
        "vreg": LogRealParam(size=num_active_views),
        ...
        "ecfp_params": DictParam({
            "num_annotations": DiscreteParam(min=10, max=50),
            "radius": ConstantParam(c=1024),
            "attn_dim_factor": RealParam(min=1, max=2)
        }),
